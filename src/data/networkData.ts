...
export const networkNodes: NetworkNode[] = [
  ...
  // Experience nodes
  { id: "abilitypath", label: "AbilityPath AI", type: "experience", description: "AI-powered front-desk intake and routing for families seeking disability services.", x: 38, y: 18 },
  ...
  { id: "sensa-vc", label: "SENSA VC", type: "experience", description: "Social impact venture capital with healthcare focus.", x: 12, y: 32 },
  {
    ...
    type: "experience",
    description:
      "Stanford entrepreneurship ecosystem — Frosh Battalion cohort (selected from 600+ freshmen).",
    x: 25,
    y: 12,
  },
